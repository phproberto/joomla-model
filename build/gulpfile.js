...
var rootPath = '../extensions/libraries/phproberto_joomla_model';

// Override of the release script
gulp.task('release', function (cb) {
	fs.readFile( '../extensions/libraries/phproberto_joomla_model/phproberto_joomla_model.xml', function(err, data) {
