...
use Phproberto\Joomla\Model\QueryModifier\DateGreaterInColumn;

/**
 * DateGreaterInColumn tests.
 *
 * @since   __DEPLOY_VERSION__
 */
class DateGreaterInColumnTest extends \TestCase
{
	...
	protected function setUp()
	{
		...
		$this->modifier = new DateGreaterInColumn($this->query, ['\'2018-02-27\''], 'a.test', [$this, 'queryCallback']);
	}
	...
	{
		$modifier = new DateGreaterInColumn($this->query, [], 'a.test', [$this, 'queryCallback']);
		$modifier->apply();
