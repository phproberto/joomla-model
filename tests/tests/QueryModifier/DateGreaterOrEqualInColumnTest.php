...
use Phproberto\Joomla\Model\QueryModifier\DateGreaterOrEqualInColumn;

/**
 * DateGreaterOrEqualInColumn tests.
 *
 * @since   __DEPLOY_VERSION__
 */
class DateGreaterOrEqualInColumnTest extends \TestCase
{
	...
	protected function setUp()
	{
		...
		$this->modifier = new DateGreaterOrEqualInColumn($this->query, ['\'2018-02-27\''], 'a.test', [$this, 'queryCallback']);
	}
	...
	{
		$modifier = new DateGreaterOrEqualInColumn($this->query, [], 'a.test', [$this, 'queryCallback']);
		$modifier->apply();
